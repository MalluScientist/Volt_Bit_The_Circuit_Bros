...
export function makeLevel(id: number): LevelSpec {
  ...
  const basePlatforms = [
    ...
    { x: 980, y: 452, w: 260, h: 30 },
    { x: 1340, y: 398, w: 240, h: 28 },
    { x: 1740, y: 460, w: 360, h: 36 },
    { x: 2200, y: 400, w: 260, h: 28 },
    { x: 2600, y: 462, w: 420, h: 36 },
    { x: 3150, y: 420, w: 320, h: 30 },
  ...
  if (id === 1) {
    ...
    return {
      ...
      collectibles: pickups(id),
      hazards: [
        { type: 'beam', x: 1640, y: 488, w: 110, h: 18 },
        { type: 'beam', x: 2740, y: 448, w: 100, h: 18 }
      ]
    };
  }
  if (id === 2) {
  ...
  return {
    ...
    collectibles: [...pickups(id).filter((item) => item.id !== 'chip-3-c'), { type: 'chip', x: 1160, y: 95, id: 'chip-3-secret' }, { type: 'powerup', x: 1220, y: 95, power: 'Fuse Shield' }],
    hazards: [
